...
class TimelineRenderer:
    ...
    def __init__(self):
        ...
        try:
            self.map_api_key = os.getenv("GOOGLE_MAP_API")
        except:
            self.map_api_key = ""
    ...
    def create_map_link(self, location: Location, exact=True):
        ...
        link = f'<iframe width="600" height="450" style="border:0" loading="lazy" allowfullscreen src="https://www.google.com/maps/embed/v1/place?key={self.map_api_key}&q={query}"></iframe>'
        # print(link)
        return link
